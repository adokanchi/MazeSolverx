...
public class Maze {
    ...
    public boolean isValidCell(int row, int col) {
        // If out of bounds of array, invalid
        if (row < 0 || col < 0 || row >= mazeGrid.length || row >= mazeGrid[0].length) {
            return false;
        }
        // If wall, invalid
        ...
        // If explored, invalid, otherwise, valid
        return !mazeGrid[row][col].isExplored();
    }
}
